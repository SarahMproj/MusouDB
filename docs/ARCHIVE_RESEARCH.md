...
The ten dossiers are Cao Cao, Liu Bei, Sun Quan, Sima Yi, Lu Bu, Zhao Yun, Sun Shangxiang, Wang Yuanji, Lu Lingqi and Zhuge Liang. History summaries and gameplay commentary are original prose. No publisher images, game files, guide tables or third-party biographies are reproduced.
