...
export const weapons: Weapon[] = [
  ...
  {id:"battle-axe",name:"Battle Axe",style:"Heavy guard break",wielders:["dian-wei"],games:["dw3","dw8","dw9"]},
];

export const imageRights = {
  current: "Original CSS-generated silhouettes and geometric compositions",
  owner: "MusouDB",
...
export const officerProfiles:Record<string,OfficerProfile>={
  ...
  "sun-quan":profile("sun-quan","Wu","Ruler of Wu","Flame Blade · balanced elemental offense","Unlocked as Wu’s succession story advances",["Sun Jian · father","Sun Ce · brother","Sun Shangxiang · sister"],["chibi","yiling"],"Sun Quan inherits the state built by his father and brother, then has to turn their momentum into durable rule. Wu’s campaign presents him as a leader learning to trust the different generations around him.","His flame-infused blade balances speed, reach, and direct damage. The moveset is forgiving while retaining strong elemental finishers and dependable officer pressure.","Wu’s hypothetical path focuses on preserving the Sun family and transforming a legacy of succession into shared victory."),
