...
export default async function Coverage(){
 ...
 const combatProfiles=rows.filter(o=>dossiers[o.id]?.gameplay).length;
 ...
 <p>{combatProfiles} profiles include community playstyle notes; {researched-combatProfiles} core profiles still need individual combat research. Publisher documentation supports the general systems. Rare conditions and playstyles are attributed to community guides and await MusouDB replay verification. Full moveset tables and the other kingdom route checklists remain open.</p>
