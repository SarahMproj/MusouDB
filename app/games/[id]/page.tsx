...
import {manual,weaponGuides} from "../../archive/dw8xl";
...
export default async function GamePage({params}:{params:Promise<{id:string}>}){
  ...
  return <main><Header active="games"/>
    ...
    <section className="detail-body"><div className="detail-main">
      ...
      {isGolden?<>
        <div className="chronicle-heading"><div><p className="eyebrow"><span/>CANONICAL ROSTER</p><h2>All 82 playable officers</h2></div><p>Browse the full roster. Ten research profiles connect historical context with edition-specific weapons and battle objectives.</p></div>
